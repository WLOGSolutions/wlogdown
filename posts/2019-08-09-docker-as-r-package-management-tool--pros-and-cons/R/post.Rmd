...
[docker.com](https://docker.com)).*](img/2018-01-29-deployment_procedure_general.png)
...
![*Diagram showing how R Suite builds zip deployment package using Docker.*](img/2018-01-29-nondocker-deployment-procedure.png) 
...
![*Diagram showing how R Suite builds production Docker image.*](img/2018-01-29-dockerbased-deployment-procedure.png) 
...
I have presented my point of view on using Docker for R software development. I have shown that Docker is a great solution but it can be tricky when reproducibility is concerned. At last I have presented how R Suite makes using Docker for R development less painful.
